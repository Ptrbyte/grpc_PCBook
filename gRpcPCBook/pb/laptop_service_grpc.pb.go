...
type LaptopServiceClient interface {
	...
	SerachLaptop(ctx context.Context, in *SerachLaptopRequest, opts ...grpc.CallOption) (LaptopService_SerachLaptopClient, error)
...
func (c *laptopServiceClient) SerachLaptop(ctx context.Context, in *SerachLaptopRequest, opts ...grpc.CallOption) (LaptopService_SerachLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[0], "/pb.LaptopService/SerachLaptop", opts...)
	if err != nil {
		return nil, err
	}
	x := &laptopServiceSerachLaptopClient{stream}
...
type LaptopService_SerachLaptopClient interface {
	Recv() (*SerachLaptopResponse, error)
	grpc.ClientStream
}

type laptopServiceSerachLaptopClient struct {
	grpc.ClientStream
}

func (x *laptopServiceSerachLaptopClient) Recv() (*SerachLaptopResponse, error) {
	m := new(SerachLaptopResponse)
...
type LaptopService_UploadImageClient interface {
	Send(*UpLoadImageResquest) error
...
func (x *laptopServiceUploadImageClient) Send(m *UpLoadImageResquest) error {
...
type LaptopServiceServer interface {
	...
	SerachLaptop(*SerachLaptopRequest, LaptopService_SerachLaptopServer) error
...
func (UnimplementedLaptopServiceServer) SerachLaptop(*SerachLaptopRequest, LaptopService_SerachLaptopServer) error {
	return status.Errorf(codes.Unimplemented, "method SerachLaptop not implemented")
}
...
func _LaptopService_SerachLaptop_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SerachLaptopRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LaptopServiceServer).SerachLaptop(m, &laptopServiceSerachLaptopServer{stream})
}

type LaptopService_SerachLaptopServer interface {
	Send(*SerachLaptopResponse) error
	grpc.ServerStream
}

type laptopServiceSerachLaptopServer struct {
	grpc.ServerStream
}

func (x *laptopServiceSerachLaptopServer) Send(m *SerachLaptopResponse) error {
...
type LaptopService_UploadImageServer interface {
	...
	Recv() (*UpLoadImageResquest, error)
	grpc.ServerStream
}
...
func (x *laptopServiceUploadImageServer) Recv() (*UpLoadImageResquest, error) {
	m := new(UpLoadImageResquest)
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SerachLaptop",
			Handler:       _LaptopService_SerachLaptop_Handler,
			ServerStreams: true,
		},
		{
