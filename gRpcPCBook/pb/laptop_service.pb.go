...
func (x *SerachLaptopRequest) Reset() {
	*x = SerachLaptopRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SerachLaptopRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SerachLaptopRequest) ProtoMessage() {}

func (x *SerachLaptopRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_laptop_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SerachLaptopRequest.ProtoReflect.Descriptor instead.
func (*SerachLaptopRequest) Descriptor() ([]byte, []int) {
	return file_proto_laptop_service_proto_rawDescGZIP(), []int{2}
}

func (x *SerachLaptopRequest) GetFilter() *Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
type SerachLaptopResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SerachLaptopResponse) Reset() {
	*x = SerachLaptopResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SerachLaptopResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SerachLaptopResponse) ProtoMessage() {}

func (x *SerachLaptopResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_laptop_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SerachLaptopResponse.ProtoReflect.Descriptor instead.
func (*SerachLaptopResponse) Descriptor() ([]byte, []int) {
	return file_proto_laptop_service_proto_rawDescGZIP(), []int{3}
}

func (x *SerachLaptopResponse) GetLaptop() *Laptop {
	if x != nil {
		return x.Laptop
	}
	return nil
...
type UpLoadImageResquest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*UpLoadImageResquest_Info
	//	*UpLoadImageResquest_ChunkData
	Data isUpLoadImageResquest_Data `protobuf_oneof:"data"`
}

func (x *UpLoadImageResquest) Reset() {
	*x = UpLoadImageResquest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpLoadImageResquest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpLoadImageResquest) ProtoMessage() {}

func (x *UpLoadImageResquest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_laptop_service_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpLoadImageResquest.ProtoReflect.Descriptor instead.
func (*UpLoadImageResquest) Descriptor() ([]byte, []int) {
	return file_proto_laptop_service_proto_rawDescGZIP(), []int{4}
}

func (m *UpLoadImageResquest) GetData() isUpLoadImageResquest_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *UpLoadImageResquest) GetInfo() *ImageInfo {
	if x, ok := x.GetData().(*UpLoadImageResquest_Info); ok {
		return x.Info
	}
	return nil
}

func (x *UpLoadImageResquest) GetChunkData() []byte {
	if x, ok := x.GetData().(*UpLoadImageResquest_ChunkData); ok {
		return x.ChunkData
	}
	return nil
}

type isUpLoadImageResquest_Data interface {
	isUpLoadImageResquest_Data()
}

type UpLoadImageResquest_Info struct {
	Info *ImageInfo `protobuf:"bytes,1,opt,name=info,proto3,oneof"`
}

type UpLoadImageResquest_ChunkData struct {
	ChunkData []byte `protobuf:"bytes,2,opt,name=chunk_data,json=chunkData,proto3,oneof"`
}

func (*UpLoadImageResquest_Info) isUpLoadImageResquest_Data() {}

func (*UpLoadImageResquest_ChunkData) isUpLoadImageResquest_Data() {}
...
func (x *RateLaptopRequest) GetScores() float64 {
	if x != nil {
		return x.Scores
	}
	return 0
...
var file_proto_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x39, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61,
	...
	0x65, 0x72, 0x61, 0x63, 0x68, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x22, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x06,
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x3a, 0x0a, 0x14, 0x53, 0x65, 0x72, 0x61, 0x63, 0x68,
	0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x22,
	...
	0x6f, 0x70, 0x22, 0x63, 0x0a, 0x13, 0x55, 0x70, 0x4c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61, 0x67,
	0x65, 0x52, 0x65, 0x73, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x6d, 0x61,
	...
	0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x47, 0x0a, 0x09, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x48, 0x0a, 0x11, 0x52,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x73,
	0x63, 0x6f, 0x72, 0x65, 0x73, 0x22, 0x77, 0x0a, 0x12, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70,
	...
	,
	...
	0x01, 0x12, 0x41, 0x0a, 0x0a, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12,
	0x15, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x61, 0x74, 0x65,
...
var file_proto_laptop_service_proto_goTypes = []interface{}{
	...
	(*SerachLaptopRequest)(nil),  // 2: pb.SerachLaptopRequest
	(*SerachLaptopResponse)(nil), // 3: pb.SerachLaptopResponse
	(*UpLoadImageResquest)(nil),  // 4: pb.UpLoadImageResquest
...
var file_proto_laptop_service_proto_depIdxs = []int32{
	...
	10, // 1: pb.SerachLaptopRequest.filter:type_name -> pb.Filter
	9,  // 2: pb.SerachLaptopResponse.laptop:type_name -> pb.Laptop
	5,  // 3: pb.UpLoadImageResquest.info:type_name -> pb.ImageInfo
	0,  // 4: pb.LaptopService.CreateLaptop:input_type -> pb.CreateLaptopRequest
	2,  // 5: pb.LaptopService.SerachLaptop:input_type -> pb.SerachLaptopRequest
	4,  // 6: pb.LaptopService.UploadImage:input_type -> pb.UpLoadImageResquest
	...
	3,  // 9: pb.LaptopService.SerachLaptop:output_type -> pb.SerachLaptopResponse
...
func file_proto_laptop_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_laptop_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SerachLaptopRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_laptop_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SerachLaptopResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_laptop_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpLoadImageResquest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_laptop_service_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*UpLoadImageResquest_Info)(nil),
		(*UpLoadImageResquest_ChunkData)(nil),
	}
	type x struct{}
